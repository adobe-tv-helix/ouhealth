...
export default async function decorate(block) {
  ...
  block.innerHTML = `<article class="system-style physician system-entry ui-repeater visible" id="PhysicianContent" universal_="true" data-onvisible="visible" data-content="true">
	...
	<div class="affiliations mar-t-1 content-style hide ui-repeater" id="PhysicianContent_ITM114341_PhysAffiliations" data-item="i" data-key="114341">
		<strong class="title-style-3">Affiliations</strong>
		<span data-item="i" data-key="76474">
			
			
				OU Health Physicians – Cardiology, Pulmonary &amp; Vascular Medicine Clinic, 
			
		</span><span data-item="i" data-key="76669">
